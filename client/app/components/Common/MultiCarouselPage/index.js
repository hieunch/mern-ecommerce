            ...
            <MDBRow>
              <MDBCol md="4">
                <MDBCard className="mb-2">
                  ...
                  <MDBCardBody>
                    <MDBCardTitle>MDBCard title 1</MDBCardTitle>
                    <MDBCardText>
              ...
              <MDBCol md="4">
                <MDBCard className="mb-2">
                  ...
                  <MDBCardBody>
                    <MDBCardTitle>MDBCard title 2</MDBCardTitle>
                    <MDBCardText>
                      Some quick example text to build on the card title and
                      make up the bulk of the card's content.
                    </MDBCardText>
              ...
              <MDBCol md="4">
                <MDBCard className="mb-2">
                  ...
                  <MDBCardBody>
                    <MDBCardTitle>MDBCard title 3</MDBCardTitle>
                    <MDBCardText>
                      Some quick example text to build on the card title and
                      make up the bulk of the card's content.
                    </MDBCardText>
            ...
            <MDBRow>
              <MDBCol md="4">
                <MDBCard className="mb-2">
                  ...
                  <MDBCardBody>
                    <MDBCardTitle>MDBCard title 4</MDBCardTitle>
                    <MDBCardText>
                      Some quick example text to build on the card title and
                      make up the bulk of the card's content.
                    </MDBCardText>
              ...
              <MDBCol md="4">
                <MDBCard className="mb-2">
                  ...
                  <MDBCardBody>
                    <MDBCardTitle>MDBCard title 5</MDBCardTitle>
                    <MDBCardText>
                      Some quick example text to build on the card title and
                      make up the bulk of the card's content.
                    </MDBCardText>
              ...
              <MDBCol md="4">
                <MDBCard className="mb-2">
                  ...
                  <MDBCardBody>
                    <MDBCardTitle>MDBCard title 6</MDBCardTitle>
                    <MDBCardText>
                      Some quick example text to build on the card title and
                      make up the bulk of the card's content.
                    </MDBCardText>
            ...
            <MDBRow>
              <MDBCol md="4">
                <MDBCard className="mb-2">
                  ...
                  <MDBCardBody>
                    <MDBCardTitle>MDBCard title 7</MDBCardTitle>
                    <MDBCardText>
                      Some quick example text to build on the card title and
                      make up the bulk of the card's content.
                    </MDBCardText>
              ...
              <MDBCol md="4">
                <MDBCard className="mb-2">
                  ...
                  <MDBCardBody>
                    <MDBCardTitle>MDBCard title 8</MDBCardTitle>
                    <MDBCardText>
                      Some quick example text to build on the card title and
                      make up the bulk of the card's content.
                    </MDBCardText>
              ...
              <MDBCol md="4">
                <MDBCard className="mb-2">
                  ...
                  <MDBCardBody>
                    <MDBCardTitle>MDBCard title 9</MDBCardTitle>
                    <MDBCardText>
                      Some quick example text to build on the card title and
                      make up the bulk of the card's content.
                    </MDBCardText>
